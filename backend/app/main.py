...
from app.routes.pagos            import pagos_router, gastos_router, caja_router  # ← separados
...
app.include_router(pagos_router)          # /pagos
app.include_router(gastos_router)         # /gastos
app.include_router(caja_router)           # /caja
